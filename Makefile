...
GO_TEST?=go tool gotestsum --format testname --
GOTESTFLAGS?=
TIMEOUT := "60m"
...
acceptance-reservation:
	$(GO_TEST) -timeout $(TIMEOUT) -tags "fixtures acceptance" ./internal/acceptance/openstack/reservation/...
.PHONY: acceptance-reservation
