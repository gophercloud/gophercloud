...
* [GH-2645](https://github.com/gophercloud/gophercloud/pull/2645) Require Go v1.20
...
* [GH-2821](https://github.com/gophercloud/gophercloud/pull/2821) The `Full` property of `containers.ListOpts` and `objects.ListOpts` is REMOVED from the Gophercloud API. The reason for that is: plaintext listing is unfixably wrong and won't handle special characters reliably (most notably: `\n`).
