...
Example of Listing Ports with propagate_uplink_status filter

	iTrue := true
	listOpts := uplinkstatuspropagation.PortPropagateUplinkStatusListOptsExt{
		ListOptsBuilder:       ports.ListOpts{NetworkID: "a87cc70a-3e15-4acf-8205-9b711a3531b7"},
	...
	err = ports.ExtractPortsInto(allPages, &filteredPorts)
	if err != nil {
		panic(err)
	}
