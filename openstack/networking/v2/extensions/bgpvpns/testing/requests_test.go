...
func TestGet(t *testing.T) {
	...
	s, err := bgpvpns.Get(fake.ServiceClient(), bgpVpnID).Extract()
	th.AssertNoErr(t, err)
	th.CheckDeepEquals(t, *s, GetBGPVPN)
}
...
func TestCreate(t *testing.T) {
	...
	r, err := bgpvpns.Create(fake.ServiceClient(), opts).Extract()
	th.AssertNoErr(t, err)
	th.AssertDeepEquals(t, *r, CreateBGPVPN)
}
...
func TestDelete(t *testing.T) {
	...
	err := bgpvpns.Delete(fake.ServiceClient(), bgpVpnID).ExtractErr()
	th.AssertNoErr(t, err)
}
...
func TestUpdate(t *testing.T) {
	...
	r, err := bgpvpns.Update(fake.ServiceClient(), bgpVpnID, opts).Extract()
	th.AssertNoErr(t, err)
	th.AssertDeepEquals(t, r.Name, *opts.Name)
}
...
func TestCreateNetworkAssociation(t *testing.T) {
	...
	r, err := bgpvpns.CreateNetworkAssociation(fake.ServiceClient(), bgpVpnID, opts).Extract()
	th.AssertNoErr(t, err)
	th.AssertDeepEquals(t, *r, CreateNetworkAssociation)
}
...
func TestGetNetworkAssociation(t *testing.T) {
	...
	s, err := bgpvpns.GetNetworkAssociation(fake.ServiceClient(), bgpVpnID, networkAssociationID).Extract()
	th.AssertNoErr(t, err)
	th.CheckDeepEquals(t, *s, GetNetworkAssociation)
}
...
func TestDeleteNetworkAssociation(t *testing.T) {
	...
	err := bgpvpns.DeleteNetworkAssociation(fake.ServiceClient(), bgpVpnID, networkAssociationID).ExtractErr()
	th.AssertNoErr(t, err)
}
...
func TestCreateRouterAssociation(t *testing.T) {
	...
	r, err := bgpvpns.CreateRouterAssociation(fake.ServiceClient(), bgpVpnID, opts).Extract()
	th.AssertNoErr(t, err)
	th.AssertDeepEquals(t, *r, CreateRouterAssociation)
}
...
func TestGetRouterAssociation(t *testing.T) {
	...
	s, err := bgpvpns.GetRouterAssociation(fake.ServiceClient(), bgpVpnID, routerAssociationID).Extract()
	th.AssertNoErr(t, err)
	th.CheckDeepEquals(t, *s, GetRouterAssociation)
}
...
func TestUpdateRouterAssociation(t *testing.T) {
	...
	r, err := bgpvpns.UpdateRouterAssociation(fake.ServiceClient(), bgpVpnID, routerAssociationID, opts).Extract()
	th.AssertNoErr(t, err)
	th.AssertDeepEquals(t, *r, UpdateRouterAssociation)
}
...
func TestDeleteRouterAssociation(t *testing.T) {
	...
	err := bgpvpns.DeleteRouterAssociation(fake.ServiceClient(), bgpVpnID, routerAssociationID).ExtractErr()
	th.AssertNoErr(t, err)
}
...
func TestCreatePortAssociation(t *testing.T) {
	...
	r, err := bgpvpns.CreatePortAssociation(fake.ServiceClient(), bgpVpnID, opts).Extract()
	th.AssertNoErr(t, err)
	th.AssertDeepEquals(t, *r, CreatePortAssociation)
}
...
func TestGetPortAssociation(t *testing.T) {
	...
	s, err := bgpvpns.GetPortAssociation(fake.ServiceClient(), bgpVpnID, portAssociationID).Extract()
	th.AssertNoErr(t, err)
	th.CheckDeepEquals(t, *s, GetPortAssociation)
}
...
func TestUpdatePortAssociation(t *testing.T) {
	...
	r, err := bgpvpns.UpdatePortAssociation(fake.ServiceClient(), bgpVpnID, portAssociationID, opts).Extract()
	th.AssertNoErr(t, err)
	th.AssertDeepEquals(t, *r, UpdatePortAssociation)
}
...
func TestDeletePortAssociation(t *testing.T) {
	...
	err := bgpvpns.DeletePortAssociation(fake.ServiceClient(), bgpVpnID, portAssociationID).ExtractErr()
	th.AssertNoErr(t, err)
}
