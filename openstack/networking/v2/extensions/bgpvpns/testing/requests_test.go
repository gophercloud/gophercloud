...
func TestGet(t *testing.T) {
	...
	s, err := bgpvpns.Get(context.TODO(), fake.ServiceClient(), bgpVpnID).Extract()
	th.AssertNoErr(t, err)
...
func TestGetNetworkAssociation(t *testing.T) {
	...
	s, err := bgpvpns.GetNetworkAssociation(context.TODO(), fake.ServiceClient(), bgpVpnID, networkAssociationID).Extract()
	th.AssertNoErr(t, err)
...
func TestGetRouterAssociation(t *testing.T) {
	...
	s, err := bgpvpns.GetRouterAssociation(context.TODO(), fake.ServiceClient(), bgpVpnID, routerAssociationID).Extract()
	th.AssertNoErr(t, err)
...
func TestGetPortAssociation(t *testing.T) {
	...
	s, err := bgpvpns.GetPortAssociation(context.TODO(), fake.ServiceClient(), bgpVpnID, portAssociationID).Extract()
	th.AssertNoErr(t, err)
