		...
		fmt.Fprintf(w, `
{
   "firewalls":[
	...
	firewalls.List(fake.ServiceClient(), firewalls.ListOpts{}).EachPage(context.TODO(), func(_ context.Context, page pagination.Page) (bool, error) {
		count++
		...
		fmt.Fprintf(w, `
{
   "firewalls":[
	...
	allPages, err := firewalls.List(fake.ServiceClient(), nil).AllPages(context.TODO())
