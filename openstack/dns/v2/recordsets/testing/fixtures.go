...
// BadGetOutput is a sample response to a bad Get call.
// The created_at field is in the wrong format.
const BadGetOutput = `
{
		"description": "This is an example record set.",
		"links": {
		...
		"zone_id": "2150b1bf-dee2-4221-9d85-11f7886fb15f",
		"zone_name": "example.com.",
		"created_at": "2014-10-24T19:59:44Z",
		"version": 1,
		"type": "A",
		"status": "PENDING",
		"action": "CREATE"
...
// HandleGetSuccessfully configures the test server to respond to a bad Get
// response.
