...
func Create(ctx context.Context, client *gophercloud.ServiceClient, opts CreateOptsBuilder) (r CreateResult) {
	...
	resp, err := client.PostWithContext(ctx, listURL(client), &b, &r.Body, nil)
...
func Update(ctx context.Context, client *gophercloud.ServiceClient, endpointID string, opts UpdateOptsBuilder) (r UpdateResult) {
	...
	resp, err := client.PatchWithContext(ctx, endpointURL(client, endpointID), &b, &r.Body, nil)
	_, r.Header, r.Err = gophercloud.ParseResponse(resp, err)
	return
}
...
func Delete(ctx context.Context, client *gophercloud.ServiceClient, endpointID string) (r DeleteResult) {
	resp, err := client.DeleteWithContext(ctx, endpointURL(client, endpointID), nil)
	_, r.Header, r.Err = gophercloud.ParseResponse(resp, err)
	return
}
