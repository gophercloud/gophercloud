...
func Get(client *gophercloud.ServiceClient, id string) (r groupresults.GetResult) {
...
func Create(client *gophercloud.ServiceClient, opts CreateOptsBuilder) (r groupresults.CreateResult) {
...
func Update(client *gophercloud.ServiceClient, groupID string, opts UpdateOptsBuilder) (r groupresults.UpdateResult) {
...
func Delete(client *gophercloud.ServiceClient, groupID string) (r groupresults.DeleteResult) {
	_, r.Err = client.Delete(deleteURL(client, groupID), nil)
	return
}

// ListGroups enumerates users that belong to a group.
func ListUsers(client *gophercloud.ServiceClient, groupID string) pagination.Pager {
	url := listUsersURL(client, groupID)
	return pagination.NewPager(client, url, func(r pagination.PageResult) pagination.Page {
