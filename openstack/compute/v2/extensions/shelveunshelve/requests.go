...
func Shelve(ctx context.Context, client *gophercloud.ServiceClient, id string) (r ShelveResult) {
	resp, err := client.PostWithContext(ctx, extensions.ActionURL(client, id), map[string]interface{}{"shelve": nil}, nil, nil)
...
func ShelveOffload(ctx context.Context, client *gophercloud.ServiceClient, id string) (r ShelveOffloadResult) {
	resp, err := client.PostWithContext(ctx, extensions.ActionURL(client, id), map[string]interface{}{"shelveOffload": nil}, nil, nil)
	_, r.Header, r.Err = gophercloud.ParseResponse(resp, err)
	return
}
