...
import (
	...
	"github.com/gophercloud/gophercloud/v2/openstack/compute/v2/defsecrules"
...
func TestList(t *testing.T) {
	...
	err := defsecrules.List(client.ServiceClient()).EachPage(context.TODO(), func(_ context.Context, page pagination.Page) (bool, error) {
		count++
