...
func Create(ctx context.Context, client *gophercloud.ServiceClient, opts CreateOptsBuilder) (r CreateResult) {
	...
	resp, err := client.PutWithContext(ctx, createURL(client, queueName), b, r.Body, &gophercloud.RequestOpts{
		OkCodes: []int{201, 204},
	})
...
func Update(ctx context.Context, client *gophercloud.ServiceClient, queueName string, opts UpdateOptsBuilder) (r UpdateResult) {
	resp, err := client.PatchWithContext(ctx, updateURL(client, queueName), opts, &r.Body, &gophercloud.RequestOpts{
...
func Get(ctx context.Context, client *gophercloud.ServiceClient, queueName string) (r GetResult) {
	resp, err := client.GetWithContext(ctx, getURL(client, queueName), &r.Body, &gophercloud.RequestOpts{
		OkCodes: []int{200},
	})
	_, r.Header, r.Err = gophercloud.ParseResponse(resp, err)
	return
...
func Delete(ctx context.Context, client *gophercloud.ServiceClient, queueName string) (r DeleteResult) {
	resp, err := client.DeleteWithContext(ctx, deleteURL(client, queueName), &gophercloud.RequestOpts{
		OkCodes: []int{204},
	})
	_, r.Header, r.Err = gophercloud.ParseResponse(resp, err)
	return
...
func GetStats(ctx context.Context, client *gophercloud.ServiceClient, queueName string) (r StatResult) {
	resp, err := client.GetWithContext(ctx, statURL(client, queueName), &r.Body, &gophercloud.RequestOpts{
		OkCodes: []int{200},
	})
	_, r.Header, r.Err = gophercloud.ParseResponse(resp, err)
	return
...
func Share(ctx context.Context, client *gophercloud.ServiceClient, queueName string, opts ShareOptsBuilder) (r ShareResult) {
	...
	resp, err := client.PostWithContext(ctx, shareURL(client, queueName), b, &r.Body, &gophercloud.RequestOpts{
		OkCodes: []int{200},
	})
	_, r.Header, r.Err = gophercloud.ParseResponse(resp, err)
	return
...
func Purge(ctx context.Context, client *gophercloud.ServiceClient, queueName string, opts PurgeOptsBuilder) (r PurgeResult) {
	...
	resp, err := client.PostWithContext(ctx, purgeURL(client, queueName), b, nil, &gophercloud.RequestOpts{
		OkCodes: []int{204},
	})
	_, r.Header, r.Err = gophercloud.ParseResponse(resp, err)
	return
