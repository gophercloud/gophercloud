...
func TestListClusterPolicies(t *testing.T) {
	...
	pageCount := 0
	clusterpolicies.List(fake.ServiceClient(), "7d85f602-a948-4a30-afd4-e84f47471c15", clusterpolicies.ListOpts{}).EachPage(func(page pagination.Page) (bool, error) {
		pageCount++
...
func TestNonJSONCannotBeExtractedIntoClusterPolicies(t *testing.T) {
	...
	clusterpolicies.List(fake.ServiceClient(), "", clusterpolicies.ListOpts{}).EachPage(func(page pagination.Page) (bool, error) {
