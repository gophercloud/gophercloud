...
import (
	...
	"github.com/gophercloud/gophercloud/v2/openstack/clustering/v1/clusters"
...
func TestListClusters(t *testing.T) {
	...
	clusters.List(fake.ServiceClient(), clusters.ListOpts{GlobalProject: new(bool)}).EachPage(context.TODO(), func(_ context.Context, page pagination.Page) (bool, error) {
		count++
...
func TestListClusterPolicies(t *testing.T) {
	...
	pageCount := 0
	err := clusters.ListPolicies(fake.ServiceClient(), ExpectedClusterPolicy.ClusterID, clusters.ListPoliciesOpts{Name: "Test"}).EachPage(context.TODO(), func(_ context.Context, page pagination.Page) (bool, error) {
		pageCount++
