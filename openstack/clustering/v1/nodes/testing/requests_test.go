...
import (
	...
	"github.com/gophercloud/gophercloud/v2/openstack/clustering/v1/nodes"
...
func TestListNodes(t *testing.T) {
	...
	count := 0
	err := nodes.List(fake.ServiceClient(), nil).EachPage(context.TODO(), func(_ context.Context, page pagination.Page) (bool, error) {
