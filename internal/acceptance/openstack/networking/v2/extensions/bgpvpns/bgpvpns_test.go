...
func TestBGPVPNRouterAssociationCRUD(t *testing.T) {
	...
	th.AssertNoErr(t, err)
	th.AssertEquals(t, assocUpdate.RouterID, routerCreated.ID)
	th.AssertEquals(t, assocUpdate.AdvertiseExtraRoutes, false)
...
func TestBGPVPNPortAssociationCRUD(t *testing.T) {
	...
	th.AssertNoErr(t, err)
	th.AssertEquals(t, assocUpdate.PortID, port.ID)
	th.AssertEquals(t, assocUpdate.AdvertiseFixedIPs, false)
